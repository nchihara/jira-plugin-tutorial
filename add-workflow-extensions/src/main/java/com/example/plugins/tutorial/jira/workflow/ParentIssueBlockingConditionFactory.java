        ...
        implements WorkflowPluginConditionFactory
{
    ...
    protected void getVelocityParamsForView(Map velocityParams, AbstractDescriptor descriptor)
    {
        ...
        for (Iterator iterator = selectedStatusIds.iterator(); iterator.hasNext();)
        {
            ...
            Status selectedStatus = constantsManager.getStatus(statusId); // constantsManager.getStatusObject() is deprecated since 7.0
...
/****  these code are generated by atlas-create-jira-plugin command
